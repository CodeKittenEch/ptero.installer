...
```bash
bash <(curl -s https://raw.githubusercontent.com/CodeKittenEch/ptero.installer/master/install.sh)
```
...
youtube video soon  [YouTube video](https://youtu.be/J3l0uL-OBWM) that illustrates the installation process.
